...
export default function Login() {
  ...
  return <div className="auth-page"><Card className="auth-card"><Card.Body className="p-4 p-md-5"><div className="text-center mb-4"><div className="auth-logo"><LogoMark /></div><p className="eyebrow">WELCOME BACK</p><h1>Write with confidence.</h1><p className="text-muted">Sign in to your WordWise workspace.</p></div>{error && <Alert variant="danger">{error}</Alert>}
