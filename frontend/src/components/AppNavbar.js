...
export default function AppNavbar() {
  ...
  return <Navbar expand="lg" className="app-navbar" sticky="top"><Container>
    ...
    <Navbar.Toggle aria-controls="main-nav" /><Navbar.Collapse id="main-nav">
      <Nav className="me-auto"><Nav.Link as={NavLink} to="/dashboard">Dashboard</Nav.Link><Nav.Link as={NavLink} to="/generate">Generate</Nav.Link><Nav.Link as={NavLink} to="/chapters">Summary & Quiz</Nav.Link><Nav.Link as={NavLink} to="/plagiarism">Originality</Nav.Link><Nav.Link as={NavLink} to="/history">History</Nav.Link><Nav.Link as={NavLink} to="/reports">Reports</Nav.Link></Nav>
